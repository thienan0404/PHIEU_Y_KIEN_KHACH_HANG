        ...
        cell: ({ row, getValue }) => {
          ...
          return (
            <select
              ...
              className="w-full min-w-[150px] text-xs border border-gray-300 rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500"
            >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="pl-9 pr-3 py-1.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 w-full sm:w-48"
            />
          </div>
