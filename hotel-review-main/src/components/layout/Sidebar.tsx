...
import { LayoutDashboard, MessageSquare, PlusCircle, Building2, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        {navItems.map(item => (
          <NavLink
            ...
            className={({ isActive }) => cn(
              ...
              isActive ? 'bg-primary-800 text-accent-400 border-r-2 border-accent-400' : 'text-primary-200 hover:bg-primary-800 hover:text-white'
            )}
          >
            <item.icon size={20} />
